...
sed -i 's/ImmortalWrt/ym-WRT/g' package/base-files/files/bin/config_generate
...
# 1. 修改 Web 界面
sed -i 's/ImmortalWrt/ym❤️my’s WRT/g' feeds/luci/modules/luci-base/po/zh-cn/base.po
sed -i 's/ImmortalWrt/ym❤️my’s WRT/g' feeds/luci/modules/luci-base/root/www/index.html
sed -i 's/<title>ImmortalWrt/<title>ym❤️my’s WRT/g' feeds/luci/modules/luci-base/root/www/index.html
